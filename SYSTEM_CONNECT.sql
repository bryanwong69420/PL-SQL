...
BEGIN
    ...
    IF :NEW.COUNTRY IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.COUNTRY, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.COUNTRY)) > 38 THEN
    ...
    IF :NEW.REGION IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.REGION, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.REGION)) > 38 THEN
    ...
    IF :NEW.CITY IS NOT NULL THEN
        IF LENGTH(:NEW.CITY) > 26 THEN
            RAISE_APPLICATION_ERROR(-20015, 'CITY must be a string of 26 bytes or less.');
        END IF;
    END IF;
    ...
    IF :NEW.SPECIFICITY IS NOT NULL THEN
        IF REGEXP_LIKE(:NEW.SPECIFICITY, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.SPECIFICITY)) > 38 THEN
    ...
    IF REGEXP_LIKE(:NEW.DOUBTTERR, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.DOUBTTERR)) > 38 THEN
    ...
    IF :NEW.ALTERNATIVE IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.ALTERNATIVE, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.ALTERNATIVE)) > 38 THEN
    ...
    IF :NEW.ATTACKTYPE1 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.ATTACKTYPE1, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.ATTACKTYPE1)) > 38 THEN
    ...
    IF :NEW.ATTACKTYPE2 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.ATTACKTYPE2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.ATTACKTYPE2)) > 38 THEN
    ...
    IF :NEW.ATTACKTYPE3 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.ATTACKTYPE3, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.ATTACKTYPE3)) > 38 THEN
    ...
    IF :NEW.TARGTYPE1 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.TARGTYPE1, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.TARGTYPE1)) > 38 THEN
    ...
    IF :NEW.TARGSUBTYPE1 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.TARGSUBTYPE1, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.TARGSUBTYPE1)) > 38 THEN
    ...
    IF :NEW.NATLTY1 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NATLTY1, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NATLTY1)) > 38 THEN
    ...
    IF :NEW.TARGTYPE2 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.TARGTYPE2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.TARGTYPE1)) > 38 THEN
    ...
    IF :NEW.TARGSUBTYPE2 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.TARGSUBTYPE2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.TARGSUBTYPE1)) > 38 THEN
    ...
    IF :NEW.NATLTY2 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NATLTY2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NATLTY1)) > 38 THEN
    ...
    IF :NEW.NATLTY3 IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NATLTY3, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NATLTY1)) > 38 THEN
    ...
    IF :NEW.NPERPS IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.NPERPS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NPERPS)) > 38 THEN
    ...
    IF :NEW.NPERPCAP IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.NPERPCAP, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NPERPCAP)) > 38 THEN
    ...
    IF :NEW.CLAIMMODE IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.CLAIMMODE, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.CLAIMMODE)) > 38 THEN
    ...
    IF :NEW.CLAIM2 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.CLAIM2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.CLAIM2)) > 38 THEN
    ...
    IF :NEW.CLAIMMODE2 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.CLAIMMODE2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.CLAIMMODE2)) > 38 THEN
    ...
    IF :NEW.CLAIM3 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.CLAIM3, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.CLAIM3)) > 38 THEN
    ...
    IF :NEW.CLAIMMODE3 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.CLAIMMODE3, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.CLAIMMODE3)) > 38 THEN
    ...
    IF :NEW.WEAPTYPE1 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPTYPE1, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPTYPE1)) > 38 THEN
    ...
    IF :NEW.WEAPSUBTYPE1 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPSUBTYPE1, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPSUBTYPE1)) > 38 THEN
    ...
    IF :NEW.WEAPTYPE2 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPTYPE2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPTYPE2)) > 38 THEN
    ...
    IF :NEW.WEAPSUBTYPE2 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPSUBTYPE2, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPSUBTYPE2)) > 38 THEN
    ...
    IF :NEW.WEAPTYPE3 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPTYPE3, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPTYPE3)) > 38 THEN
    ...
    IF :NEW.WEAPSUBTYPE3 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPSUBTYPE3, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPSUBTYPE3)) > 38 THEN
    ...
    IF :NEW.WEAPTYPE4 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPTYPE4, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPTYPE4)) > 38 THEN
    ...
    IF :NEW.WEAPSUBTYPE4 IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.WEAPSUBTYPE4, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.WEAPSUBTYPE4)) > 38 THEN
    ...
    IF :NEW.NKILL IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NKILL, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NKILL)) > 38 THEN
    ...
    IF :NEW.NKILLUS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NKILLUS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NKILLUS)) > 38 THEN
    ...
    IF :NEW.NWOUND IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NWOUND, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NWOUND)) > 38 THEN
    ...
    IF :NEW.NWOUNDUS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NWOUNDUS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NWOUNDUS)) > 38 THEN
    ...
    IF :NEW.NWOUNDTE IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NWOUNDTE, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NWOUNDTE)) > 38 THEN
    ...
    IF :NEW.PROPERTY IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.PROPERTY, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.PROPERTY)) > 38 THEN
    ...
    IF :NEW.PROPEXTENT IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.PROPEXTENT, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.PROPEXTENT)) > 38 THEN
    ...
    IF :NEW.PROPVALUE IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.PROPVALUE, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NWOUNDUS)) > 38 THEN
    ...
    IF :NEW.NHOSTKID IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NHOSTKID, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NHOSTKID)) > 38 THEN
    ...
    IF :NEW.NHOSTKIDUS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NHOSTKIDUS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NHOSTKIDUS)) > 38 THEN
    ...
    IF :NEW.NHOURS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NHOURS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NHOURS)) > 38 THEN
    ...
    IF :NEW.NDAYS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NDAYS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NDAYS)) > 38 THEN
    ...
    IF :NEW.RANSOMAMTUS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.RANSOMAMTUS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.RANSOMAMTUS)) > 38 THEN
    ...
    IF :NEW.RANSOMPAID IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.RANSOMPAID, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.RANSOMPAID)) > 38 THEN
    ...
    IF :NEW.RANSOMPAIDUS IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.RANSOMPAIDUS, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.RANSOMPAIDUS)) > 38 THEN
    ...
    IF :NEW.HOSTKIDOUTCOME IS NOT NULL THEN 
        IF NOT REGEXP_LIKE(:NEW.HOSTKIDOUTCOME, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.HOSTKIDOUTCOME)) > 38 THEN
    ...
    IF :NEW.NRELEASED IS NOT NULL THEN
        IF NOT REGEXP_LIKE(:NEW.NRELEASED, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.NRELEASED)) > 38 THEN
    ...
    IF NOT REGEXP_LIKE(:NEW.INT_LOG, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.INT_LOG)) > 38 THEN
    ...
    IF NOT REGEXP_LIKE(:NEW.INT_IDEO, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.INT_IDEO)) > 38 THEN
    ...
    IF NOT REGEXP_LIKE(:NEW.INT_MISC, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.INT_MISC)) > 38 THEN
    ...
    IF NOT REGEXP_LIKE(:NEW.INT_ANY, '^[0-9]+$') OR LENGTH(TO_CHAR(:NEW.INT_ANY)) > 38 THEN
